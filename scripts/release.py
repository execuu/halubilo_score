...
files=['app.py','wsgi.py','requirements.txt','README.md','DEPLOYMENT.md','deploy_pythonanywhere.py','migrate_db.py']
...
files.extend(['static/app.css','static/app.js'])
for name in files:
